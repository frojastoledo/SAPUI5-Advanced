    ...
    function (Controller) {
        ...
        return Controller.extend("logaligroup.employees.controller.Main", {
            ...
            onInit: function () {
                ...
                oView.setModel(oJSONModelEmpl, "jsonEmployees"); //odataNorthwind
            ...
            onSaveODataIncidence: function (channelId, eventId, data) {
                ...
                var employeeId = this._detailEmployeeView.getBindingContext("odataNortwind").getObjetc().EmployeeID;
